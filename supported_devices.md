...
#### Receptors:
```
+ BH1750		Receptor	I2C		Light		Luminocity sensor
+ BME280		Receptor	I2C		Pressure	Temperature, humidity & pressure sensor
+ BMP280		Receptor	I2C		T+H		Temperature & pressure sensor: 20-bit
...
+ MAX44009/GY49		Receptor	I2C		Light		Luminocity sensor
...
### Not tested:
```
~ BMP085		Receptor	I2C		Pressure	Pressure sensor: 16..19-bit
~ BMP180		Receptor	I2C		Pressure	Pressure sensor
```
